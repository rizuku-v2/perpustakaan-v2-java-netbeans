package Master;
import Crud.CrudPenulis;
public class Penulis extends javax.swing.JPanel {
    private int idPenulis;
    private CrudPenulis crudPenulis = new CrudPenulis();
    public Penulis() {
        initComponents();
        crudPenulis.tampil(tblPenulis);
    }
    public void reset(){
        tnama.setText("");
    }
    ...
    public void rowClicked() {
        ...
        idPenulis = Integer.parseInt(
            tblPenulis.getValueAt(baris, 0).toString()
        );
        tnama.setText(
            tblPenulis.getValueAt(baris, 1).toString()
        );
    }
    ...
    private void beditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_beditActionPerformed
        String nama = tnama.getText();        
        crudPenulis.update(idPenulis,nama);
        reset();
        crudPenulis.tampil(tblPenulis);
    }//GEN-LAST:event_beditActionPerformed

    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        crudPenulis.hapus(idPenulis);
        reset();
        crudPenulis.tampil(tblPenulis);
