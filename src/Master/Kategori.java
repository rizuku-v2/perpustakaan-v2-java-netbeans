...
public class Kategori extends javax.swing.JPanel {
    ...
    private CrudKategori crudKategori = new CrudKategori();
    public Kategori() {
        initComponents();
        crudKategori.tampil(tblKategori);
    }
    public void reset(){
        tnama.setText("");
    }
    ...
    private void btambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btambahActionPerformed
        ...
        crudKategori.simpan(nama);
        reset();
        crudKategori.tampil(tblKategori);
    }//GEN-LAST:event_btambahActionPerformed

    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        crudKategori.hapus(idKategori);
        reset();
        crudKategori.tampil(tblKategori);
    ...
    private void beditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_beditActionPerformed
        String nama = tnama.getText();
        crudKategori.update(idKategori,nama);
        reset();
        crudKategori.tampil(tblKategori);
